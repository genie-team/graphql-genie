...
const buildClient = (genie) => __awaiter(this, void 0, void 0, function* () {
    ...
    console.log(addPost);
    const addAddress = yield client.mutate({
        mutation: gql `mutation {
			updateUser(
				input: {
					data: {
    ...
    const disconnectAddress = yield client.mutate({
        mutation: gql `mutation {
			updateUser(
				input: {
					data: {
    ...
    const updatePostOnUser = yield client.mutate({
        mutation: gql `mutation {
			updateUser(
				input: {
					data: {
    ...
    const upsertCreate = yield client.mutate({
        mutation: gql `mutation {
			upsertUser(
				input: {
					create: {
    ...
    const upsertUpdate = yield client.mutate({
        mutation: gql `mutation {
			upsertUser(
				input: {
					create: {
    ...
    const nestedUpsertCreate = yield client.mutate({
        mutation: gql `mutation {
			updateUser(
				input: {
					data: {
    ...
    const nestedUpsertUpdate = yield client.mutate({
        mutation: gql `mutation {
			updateUser(
				input: {
					data: {
    ...
    const nestedUpsertCreateSingle = yield client.mutate({
        mutation: gql `mutation {
			updateUser(
				input: {
					data: {
    ...
    const nestedUpsertUpdateSingle = yield client.mutate({
        mutation: gql `mutation {
			updateUser(
				input: {
					data: {
    ...
    const nestedUpdateSingle = yield client.mutate({
        mutation: gql `mutation {
			updateUser(
				input: {
					data: {
    ...
    const deleteUser = yield client.mutate({
        mutation: gql `mutation {
			deleteUser(input: {
				where: {
					email: "corey@genie.com"
    ...
    const deleteAddressFromUser = yield client.mutate({
        mutation: gql `mutation {
			updateUser(
				input: {
					data: {
    ...
    const deletePostFromUser = yield client.mutate({
        mutation: gql `mutation {
			updateUser(
				input: {
					data: {
	...
	`;
    let result = yield client.mutate({
